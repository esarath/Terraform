...
provider "azurerm" {
  subscription_id = "920f4df7-3d86-45f6-94ae-c9ca5764ebf4" //AMSAzureLab_VS
  features {
  }
}
...
resource "azurerm_virtual_machine" "apache_terraform_site" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo '<h1><center>Welcome to DELL Hyperscaler Team!!</center></h1>' > index.html",
      "echo '<h1><center>Sarath Babu</center></h1>' >> index.html",
